...
**Exercise.** Treat height as a factor and generate a summary of F0 mean according to height difference. Relate the summary back to our discussion of the Johnson reading. 

```{r}

```

**Exercise.** In preparation for the next lab class, think of other summaries that may be useful in analyzing the data from assignment 1 and 3.